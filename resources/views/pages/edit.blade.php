                            ...
                            <div class="card card-plain">
                                ...
                                <div class="card-body">
                                    <form method="POST" action="/menu/{{ $menu->id }}" enctype="multipart/form-data">
                                        ...
                                        @if ($menu->gambar)
                                            <img src="{{ asset('storage/' . $menu->gambar) }}" class="img-thumbnail mb-2"
                                                style="max-width:150px;">
                                        @endif
                                        <label for="formFile" class="form-label">Upload Gambar</label>
                                        <div class="input-group input-group-outline mb-3">
                                            <input type="file" id="formFile" class="form-control" name="gambar">
                                        </div <label class="form-label">Harga</label>
                                        <div class="input-group input-group-outline mb-3">
                                        ...
                                        <div class="text-center">
                                            <button type="submit"
                                                class="btn btn-lg bg-gradient-dark btn-lg w-100 mt-4 mb-0">Update
                                                Menu</button>
                                        </div>
                                    </form>
                                </div>
